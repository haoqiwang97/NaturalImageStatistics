...
# plt.savefig("predicted_red_no_contrast_surf_pre", dpi=300)
...
# plt.savefig("predicted_green_no_contrast_surf_pre", dpi=300)
...
plt.savefig("predicted_blue_no_contrast_surf_pre", dpi=300)
